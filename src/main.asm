%include 'include/exit_subroutines.asm'
...
_start:
    ...
    mov rsi, msg        ; Copy the address of the first character of msg to rsi
    mov rdx, 12         ; Read 12 bytes
    syscall             ; Write read bytes to stdout
